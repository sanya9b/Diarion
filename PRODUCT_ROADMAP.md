...
- Графік «настрій за годинами» зважує по спостереженнях, а не по днях (на відміну від донату), тож у вікні «тиждень» один ретельно залогований день може домінувати над годиною. Приглушення за кількістю від цього не рятує — воно ловить малу вибірку, а не вузьку. За потреби додати показник «днів у вибірці».
