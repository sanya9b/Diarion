...
3. **Color Palette:** Використовуй заспокійливі природні відтінки (кремові, бежеві, оливкові, глибокий синьо-сірий, темно-сірий для контрасту).
4. **Monochromatic Style:** Усі UI елементи (кнопки, бейджі, іконки, статуси) мають бути суворо монохромними. Уникай використання яскравих різнокольорових маркерів (червоний для помилок/високого пріоритету, зелений для успіху). Використовуй виключно базову палітру.
